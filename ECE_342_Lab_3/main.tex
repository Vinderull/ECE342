...
\begin{titlepage}
    ...
    %Berkay suggested this title in the meeting
         \textbf{{\huge Task 3: MOSFET Based Logic Gates and Digital Oscillator}}
         ...
         \textbf{{\Large Ryan Dufour \\ Phil Robb\newline}}
    \vspace{1cm}
        ...
        \noindent 
        The design, simulation, and construction of a signal generator using MOSFET based logic gates are described. In task 3 of the optical uplink project, several inverting circuits are explored using NMOS and CMOS MOSFETS. An inverter based ring oscillator was simulated and constructed using the CD4007 CMOS integrated circuit. Simulations were also conducted using various configurations of NMOS and PMOS inverters, which are described in this report. The ring oscillator was chosen to be the signal generator for the optical uplink project. The required output of the CMOS ring oscillator for the use in the optical uplink project are a frequency  of 20kHz, a 50\% duty-cycle, and a 5V$_{pp}$ amplitude. The final design featured a sinusoidal wave form, at a frequency of 19.8kHz, a duty cycle of 51\% and 4.9V$_{pp}$ amplitude. .
...
\subfile{Introduction/Introduction}
  ...
  \section{Experimental Implementation}
    \subfile{ExperimentalImplementation/ExperimentalImplementation.tex}
